...
| 🔌 [MCP Servers](./docs/mcp-servers.md) [![npm](https://img.shields.io/badge/npm-shuji--bonji-CB3837?style=flat&logo=npm&logoColor=white)](https://www.npmjs.com/~shuji-bonji) | PDF・Web Spec・houki-hub・DTIR の4ファミリー + 単発 MCP（epsg / ifc-core / xcomet / rxjs）                                                                                                                                                                                                                                                       |
