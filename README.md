...
| :---: | :--- | :--- | :--- |
| 1 | **understanding-llm-through-claude-code** | LLM の構造的制約を理解し、Claude Code の設計思想から「なぜそう設定するのか」を学ぶ | [Site](http://localhost:4173/understanding-llm-through-claude-code/ja/) · [GitHub](https://github.com/shuji-bonji/understanding-llm-through-claude-code) |
