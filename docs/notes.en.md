...
[← Back to README](../README.en.md) · 🌐 [日本語版](./notes.md)

Other notes and templates. On the employment side: AWS operations for a video-delivery service (S3 / CloudFront / EC2 / DirectConnect / MediaLive / Aurora / DynamoDB / CloudWatch) and AWS certifications (CLF / SAA). On the personal side: a local-LLM stack and a translation-pipeline PoC.
...
- [Local LLM on a Mac](https://github.com/shuji-bonji/local-llm-on-mac) (Ollama / LiteLLM / LangChain.js)
- [DTIR translation pipeline (PoC)](https://github.com/shuji-bonji/dtir-docx-pipeline) — translate mixed-language docx without breaking layout
