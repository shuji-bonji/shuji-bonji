...
| **pdf-publish-skill**          | PDF family MCP 群で write → read-back → verify の品質ゲート付き納品パイプラインを編成し、Publish Report 付きで納品するスキル             | [GitHub](https://github.com/shuji-bonji/pdf-publish-skill)          |
...
> [!NOTE]
> **pdf-trust-skill**（入口: 受入監査）と **pdf-publish-skill**（出口: 納品）は [PDF family](./mcp-servers.md#-pdf-family)、**houki-research-skill** は [houki-hub family](./mcp-servers.md#-houki-hub-family) の MCP 群を編成するオーケストレーション Skill です。
