...
> [!NOTE]
> **pdf-trust-skill** (intake gate) and **pdf-publish-skill** (delivery gate) orchestrate the [PDF family](./mcp-servers.en.md#-pdf-family) MCPs, and **houki-research-skill** orchestrates the [houki-hub family](./mcp-servers.en.md#-houki-hub-family) MCPs.
