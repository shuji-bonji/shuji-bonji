...
What I build now falls into four parts.

1. **Product** — [e-shiwake](https://github.com/shuji-bonji/e-shiwake) ([demo](https://shuji-bonji.github.io/e-shiwake/))
   ...
   v0.7.0 links invoices to journal entries and derives payment status from them.
2. **Tools for reaching primary sources** — [MCP servers](https://www.npmjs.com/~shuji-bonji) and [Claude Skills](https://github.com/shuji-bonji/claude-plugins) that let agents read the source text of PDF / W3C / RFC / Japanese law directly. All 13 published MCP servers now run on MCP SDK v2 (`@modelcontextprotocol/server` 2.x).
3. **Family documentation sites** — [PDF Agent Stack](https://shuji-bonji.github.io/pdf-agent-stack/) (PDF), [houki-hub](https://shuji-bonji.github.io/houki-hub/) (Japanese law, published 2026-09-08), [rfcxml-mcp](https://shuji-bonji.github.io/rfcxml-mcp/) (RFC).
4. **Design-decision support** — [ai-design-advisor](https://github.com/shuji-bonji/ai-design-advisor). A skill that names what has not been decided yet when you are shaping a generative-AI system. Its central rule is to leave missing input unfilled rather than guess.
